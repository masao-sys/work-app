...
ActiveRecord::Schema.define(version: 2021_03_21_125512) do
  ...
  create_table "development_comments", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.bigint "development_id", null: false
    t.text "content", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["development_id"], name: "index_development_comments_on_development_id"
    t.index ["user_id"], name: "index_development_comments_on_user_id"
  end
